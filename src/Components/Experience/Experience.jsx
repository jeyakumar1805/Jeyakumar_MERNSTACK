        ...
        <div>
          <div className="flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center">
            <span className="text-white">
              <h2 className="leading-tight">Programming Languages: C, C++, Java, Python, JavaScript </h2>
          ...
          <div className="flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg  p-4 items-center">
            ...
            <span className="text-white">
              <h2 className="leading-tight">Technologies/Frameworks: HTML5, CSS3,ReactJS</h2>
            </span>
          </div>
          <div className="flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg  p-4 items-center">
            <span className="text-white">
